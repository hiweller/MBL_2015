function [PctUconeEdge, PctSconeEdge, PctMconeEdge, PctLconeEdge] = RaptorIsoColor(Directory, Rad4Umat)
...
% subaxis(2,2,3, 'Spacing', 0.03), imshow(DetectedMconeEdge); title('Iso M-cone');
