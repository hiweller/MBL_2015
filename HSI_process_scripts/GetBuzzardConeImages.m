...
export_fig([FlounDir, 'Buzzard_DCimg_LoG_up.tiff']);
...
export_fig([FlounDir, 'Buzzard_LMSimg.tiff']);

figure
imshow(MSUimg); title('MSU');
export_fig([FlounDir, 'Buzzard_MSUimg.tiff']);
...
export_fig([FlounDir, 'Buzzard_IsoLMSimg.tiff']);

figure
imshow(IsoMSUimg); title('Iso-MSU');
export_fig([FlounDir, 'Buzzard_IsoMSUimg.tiff']);
...
export_fig([FlounDir, 'Buzzard_IsoUSMLcones_LoG_up.tiff']);
