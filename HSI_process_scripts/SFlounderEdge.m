function [PercentEdge1pixel, CtrlEdge1pixel] = SFlounderEdge(Directory, Rad4Umat)
...
for i = 1:16
    Simg(:,:,i) = RefObjectImg(:,:,i)*Paralichthys2Cones(1,i); % use Up direction of light field
